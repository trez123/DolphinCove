...
namespace DolphinCove.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public ExperiencesController(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Experiences != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Experiences'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ExperienceName,ExperiencePrice,ExperienceImage1,ExperienceImage2,ExperienceImage3,ExperienceImage4")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ExperienceName,ExperiencePrice,ExperienceImage1,ExperienceImage2,ExperienceImage3,ExperienceImage4")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
